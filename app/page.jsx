    ...
    <main className='bg-gray-100 text-gray-800 font-sans min-h-screen'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        <div className='space-y-6'>
          <div className='bg-white p-6 rounded shadow-md flex flex-col sm:flex-row items-center sm:items-start gap-6'>
            {/* User Image */}
            <img
              src={user.imageUrl}
            ...
            <div className='flex-1'>
              ...
              <p className='text-gray-600 mb-4'>
                Here&#39;s a quick overview of your recent study activity. Stay
